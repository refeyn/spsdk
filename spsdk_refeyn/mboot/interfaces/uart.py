...
from spsdk_refeyn.mboot.protocol.serial_protocol import MbootSerialProtocol
from spsdk_refeyn.utils.interfaces.device.serial_device import SerialDevice
